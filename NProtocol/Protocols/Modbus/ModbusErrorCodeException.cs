...
namespace NProtocol.Protocols.Modbus
{
    public class ModbusErrorCodeException : ReceivedException
    {
        ...
        public static IReadOnlyDictionary<byte, string> AbnormalFuncCodeValues => new Dictionary<byte, string>()
        {
        ...
        public static IReadOnlyDictionary<byte, string> ErrorCodeValues => new Dictionary<byte, string>()
        {
